...
try:
    ...
    url = "https://www.google.com/search?q=" + "weather" + "denton"
...
system_prompt = (f"""You're a helpful AI assistant.
    ...
    while True:
        ...
        try:
            with sr.Microphone() as source2:
                ...
                audio2 = recog.listen(source2, phrase_time_limit=10)
                ...
                if wake_word in initail_command:  
                    ...
                    while True:
                        ...
                        print("Listening...")
                        audio3 = recog.listen(source2, snowboy_configuration=True)
